...
ЛИД (relevant=true, should_reply=true, confidence 0.8-1.0) — это ПРЯМАЯ ЛИЧНАЯ
просьба по услуге от первого лица:
- «посоветуйте / подскажите / ищу / нужен / кто знает / где взять / скиньте
  контакт» + услуга, обращённые к себе.
Такие сообщения пропускать НАДО, это и есть цель. Явную просьбу не занижай.
